...
class ChatBot():
  ...
  pinecone.init(
      api_key= "pcsk_6m77cF_7DhPv9ocCnBhYdyWrgNoFYnpZDcvQNTV7ziJUj3Rw2c7YrqHiHuavjSeNbfUBiE",
  ...
  llm = HuggingFaceHub(
      repo_id=repo_id, model_kwargs={"temperature": 0.8, "top_p": 0.8, "top_k": 50}, huggingfacehub_api_token="<your HUGGINGFACE api key here>"
  )
